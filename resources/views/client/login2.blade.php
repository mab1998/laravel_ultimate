...
<body>
    ...
    <div class="login-content">
        ...
        <div class="nk-block toggled" id="l-login">
            <form id="form1" class="nk-form" role="form" method="post" action="{{url('client/get-login')}}">
        ...
        <div class="nk-block" id="l-register">
            {{-- <form class="nk-form"> --}}
            <form class="nk-form" role="form" method="post" action="{{url('user/post-registration')}}">
